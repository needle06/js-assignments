...
function getRectangleString(width, height) {
    let acc = ""
    function drawRow(width, beginChar, fillChar, endChar) {
        let cap = beginChar;
...
function isString(value) {
    ...
    if (typeof value === "object" && value && "valueOf" in value && typeof value.valueOf() === "string") return true;
    return false;
}
